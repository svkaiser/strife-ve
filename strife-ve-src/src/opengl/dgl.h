...
#ifdef SVE_PLAT_SWITCH
#define dglGetString(name)  ctx.glGetString(name)
#else
...
#ifdef SVE_PLAT_SWITCH
#define dglAccum(op, value) ctx.glAccum(op, value)
#define dglAlphaFunc(func, ref) ctx.glAlphaFunc(func, ref)
#define dglAreTexturesResident(n, textures, residences) ctx.glAreTexturesResident(n, textures, residences)
#define dglArrayElement(i) ctx.glArrayElement(i)
#define dglBegin(mode) ctx.glBegin(mode)
#define dglBindTexture(target, texture) ctx.glBindTexture(target, texture)
#define dglBitmap(width, height, xorig, yorig, xmove, ymove, bitmap) ctx.glBitmap(width, height, xorig, yorig, xmove, ymove, bitmap)
#define dglBlendFunc(sfactor, dfactor) ctx.glBlendFunc(sfactor, dfactor)
#define dglCallList(list) ctx.glCallList(list)
#define dglCallLists(n, type, lists) ctx.glCallLists(n, type, lists)
#define dglClear(mask) ctx.glClear(mask)
#define dglClearAccum(red, green, blue, alpha) ctx.glClearAccum(red, green, blue, alpha)
#define dglClearColor(red, green, blue, alpha) ctx.glClearColor(red, green, blue, alpha)
#define dglClearDepth(depth) ctx.glClearDepth(depth)
#define dglClearIndex(c) ctx.glClearIndex(c)
#define dglClearStencil(s) ctx.glClearStencil(s)
#define dglClipPlane(plane, equation) ctx.glClipPlane(plane, equation)
#define dglColor3b(red, green, blue) ctx.glColor3b(red, green, blue)
#define dglColor3bv(v) ctx.glColor3bv(v)
#define dglColor3d(red, green, blue) ctx.glColor3d(red, green, blue)
#define dglColor3dv(v) ctx.glColor3dv(v)
#define dglColor3f(red, green, blue) ctx.glColor3f(red, green, blue)
#define dglColor3fv(v) ctx.glColor3fv(v)
#define dglColor3i(red, green, blue) ctx.glColor3i(red, green, blue)
#define dglColor3iv(v) ctx.glColor3iv(v)
#define dglColor3s(red, green, blue) ctx.glColor3s(red, green, blue)
#define dglColor3sv(v) ctx.glColor3sv(v)
#define dglColor3ub(red, green, blue) ctx.glColor3ub(red, green, blue)
#define dglColor3ubv(v) ctx.glColor3ubv(v)
#define dglColor3ui(red, green, blue) ctx.glColor3ui(red, green, blue)
#define dglColor3uiv(v) ctx.glColor3uiv(v)
#define dglColor3us(red, green, blue) ctx.glColor3us(red, green, blue)
#define dglColor3usv(v) ctx.glColor3usv(v)
#define dglColor4b(red, green, blue, alpha) ctx.glColor4b(red, green, blue, alpha)
#define dglColor4bv(v) ctx.glColor4bv(v)
#define dglColor4d(red, green, blue, alpha) ctx.glColor4d(red, green, blue, alpha)
#define dglColor4dv(v) ctx.glColor4dv(v)
#define dglColor4f(red, green, blue, alpha) ctx.glColor4f(red, green, blue, alpha)
#define dglColor4fv(v) ctx.glColor4fv(v)
#define dglColor4i(red, green, blue, alpha) ctx.glColor4i(red, green, blue, alpha)
#define dglColor4iv(v) ctx.glColor4iv(v)
#define dglColor4s(red, green, blue, alpha) ctx.glColor4s(red, green, blue, alpha)
#define dglColor4sv(v) ctx.glColor4sv(v)
#define dglColor4ub(red, green, blue, alpha) ctx.glColor4ub(red, green, blue, alpha)
#define dglColor4ubv(v) ctx.glColor4ubv(v)
#define dglColor4ui(red, green, blue, alpha) ctx.glColor4ui(red, green, blue, alpha)
#define dglColor4uiv(v) ctx.glColor4uiv(v)
#define dglColor4us(red, green, blue, alpha) ctx.glColor4us(red, green, blue, alpha)
#define dglColor4usv(v) ctx.glColor4usv(v)
#define dglColorMask(red, green, blue, alpha) ctx.glColorMask(red, green, blue, alpha)
#define dglColorMaterial(face, mode) ctx.glColorMaterial(face, mode)
#define dglColorPointer(size, type, stride, pointer) ctx.glColorPointer(size, type, stride, pointer)
#define dglCopyPixels(x, y, width, height, type) ctx.glCopyPixels(x, y, width, height, type)
#define dglCopyTexImage1D(target, level, internalFormat, x, y, width, border) ctx.glCopyTexImage1D(target, level, internalFormat, x, y, width, border)
#define dglCopyTexImage2D(target, level, internalFormat, x, y, width, height, border) ctx.glCopyTexImage2D(target, level, internalFormat, x, y, width, height, border)
#define dglCopyTexSubImage1D(target, level, xoffset, x, y, width) ctx.glCopyTexSubImage1D(target, level, xoffset, x, y, width)
#define dglCopyTexSubImage2D(target, level, xoffset, yoffset, x, y, width, height) ctx.glCopyTexSubImage2D(target, level, xoffset, yoffset, x, y, width, height)
#define dglCullFace(mode) ctx.glCullFace(mode)
#define dglDeleteLists(list, range) ctx.glDeleteLists(list, range)
#define dglDeleteTextures(n, textures) ctx.glDeleteTextures(n, textures)
#define dglDepthFunc(func) ctx.glDepthFunc(func)
#define dglDepthMask(flag) ctx.glDepthMask(flag)
#define dglDepthRange(zNear, zFar) ctx.glDepthRange(zNear, zFar)
#define dglDisable(cap) ctx.glDisable(cap)
#define dglDisableClientState(array) ctx.glDisableClientState(array)
#define dglDrawArrays(mode, first, count) ctx.glDrawArrays(mode, first, count)
#define dglDrawBuffer(mode) ctx.glDrawBuffer(mode)
#define dglDrawElements(mode, count, type, indices) ctx.glDrawElements(mode, count, type, indices)
#define dglDrawPixels(width, height, format, type, pixels) ctx.glDrawPixels(width, height, format, type, pixels)
#define dglEdgeFlag(flag) ctx.glEdgeFlag(flag)
#define dglEdgeFlagPointer(stride, pointer) ctx.glEdgeFlagPointer(stride, pointer)
#define dglEdgeFlagv(flag) ctx.glEdgeFlagv(flag)
#define dglEnable(cap) ctx.glEnable(cap)
#define dglEnableClientState(array) ctx.glEnableClientState(array)
#define dglEnd() ctx.glEnd()
#define dglEndList() ctx.glEndList()
#define dglEvalCoord1d(u) ctx.glEvalCoord1d(u)
#define dglEvalCoord1dv(u) ctx.glEvalCoord1dv(u)
#define dglEvalCoord1f(u) ctx.glEvalCoord1f(u)
#define dglEvalCoord1fv(u) ctx.glEvalCoord1fv(u)
#define dglEvalCoord2d(u, v) ctx.glEvalCoord2d(u, v)
#define dglEvalCoord2dv(u) ctx.glEvalCoord2dv(u)
#define dglEvalCoord2f(u, v) ctx.glEvalCoord2f(u, v)
#define dglEvalCoord2fv(u) ctx.glEvalCoord2fv(u)
#define dglEvalMesh1(mode, i1, i2) ctx.glEvalMesh1(mode, i1, i2)
#define dglEvalMesh2(mode, i1, i2, j1, j2) ctx.glEvalMesh2(mode, i1, i2, j1, j2)
#define dglEvalPoint1(i) ctx.glEvalPoint1(i)
#define dglEvalPoint2(i, j) ctx.glEvalPoint2(i, j)
#define dglFeedbackBuffer(size, type, buffer) ctx.glFeedbackBuffer(size, type, buffer)
#define dglFinish() ctx.glFinish()
#define dglFlush() ctx.glFlush()
#define dglFogf(pname, param) ctx.glFogf(pname, param)
#define dglFogfv(pname, params) ctx.glFogfv(pname, params)
#define dglFogi(pname, param) ctx.glFogi(pname, param)
#define dglFogiv(pname, params) ctx.glFogiv(pname, params)
#define dglFrontFace(mode) ctx.glFrontFace(mode)
#define dglFrustum(left, right, bottom, top, zNear, zFar) ctx.glFrustum(left, right, bottom, top, zNear, zFar)
#define dglGenLists(range) ctx.glGenLists(range)
#define dglGenTextures(n, textures) ctx.glGenTextures(n, textures)
#define dglGetBooleanv(pname, params) ctx.glGetBooleanv(pname, params)
#define dglGetClipPlane(plane, equation) ctx.glGetClipPlane(plane, equation)
#define dglGetDoublev(pname, params) ctx.glGetDoublev(pname, params)
#define dglGetError() ctx.glGetError()
#define dglGetFloatv(pname, params) ctx.glGetFloatv(pname, params)
#define dglGetIntegerv(pname, params) ctx.glGetIntegerv(pname, params)
#define dglGetLightfv(light, pname, params) ctx.glGetLightfv(light, pname, params)
#define dglGetLightiv(light, pname, params) ctx.glGetLightiv(light, pname, params)
#define dglGetMapdv(target, query, v) ctx.glGetMapdv(target, query, v)
#define dglGetMapfv(target, query, v) ctx.glGetMapfv(target, query, v)
#define dglGetMapiv(target, query, v) ctx.glGetMapiv(target, query, v)
#define dglGetMaterialfv(face, pname, params) ctx.glGetMaterialfv(face, pname, params)
#define dglGetMaterialiv(face, pname, params) ctx.glGetMaterialiv(face, pname, params)
#define dglGetPixelMapfv(map, values) ctx.glGetPixelMapfv(map, values)
#define dglGetPixelMapuiv(map, values) ctx.glGetPixelMapuiv(map, values)
#define dglGetPixelMapusv(map, values) ctx.glGetPixelMapusv(map, values)
#define dglGetPointerv(pname, params) ctx.glGetPointerv(pname, params)
#define dglGetPolygonStipple(mask) ctx.glGetPolygonStipple(mask)
#define dglGetTexEnvfv(target, pname, params) ctx.glGetTexEnvfv(target, pname, params)
#define dglGetTexEnviv(target, pname, params) ctx.glGetTexEnviv(target, pname, params)
#define dglGetTexGendv(coord, pname, params) ctx.glGetTexGendv(coord, pname, params)
#define dglGetTexGenfv(coord, pname, params) ctx.glGetTexGenfv(coord, pname, params)
#define dglGetTexGeniv(coord, pname, params) ctx.glGetTexGeniv(coord, pname, params)
#define dglGetTexImage(target, level, format, type, pixels) ctx.glGetTexImage(target, level, format, type, pixels)
#define dglGetTexLevelParameterfv(target, level, pname, params) ctx.glGetTexLevelParameterfv(target, level, pname, params)
#define dglGetTexLevelParameteriv(target, level, pname, params) ctx.glGetTexLevelParameteriv(target, level, pname, params)
#define dglGetTexParameterfv(target, pname, params) ctx.glGetTexParameterfv(target, pname, params)
#define dglGetTexParameteriv(target, pname, params) ctx.glGetTexParameteriv(target, pname, params)
#define dglHint(target, mode) ctx.glHint(target, mode)
#define dglIndexMask(mask) ctx.glIndexMask(mask)
#define dglIndexPointer(type, stride, pointer) ctx.glIndexPointer(type, stride, pointer)
#define dglIndexd(c) ctx.glIndexd(c)
#define dglIndexdv(c) ctx.glIndexdv(c)
#define dglIndexf(c) ctx.glIndexf(c)
#define dglIndexfv(c) ctx.glIndexfv(c)
#define dglIndexi(c) ctx.glIndexi(c)
#define dglIndexiv(c) ctx.glIndexiv(c)
#define dglIndexs(c) ctx.glIndexs(c)
#define dglIndexsv(c) ctx.glIndexsv(c)
#define dglIndexub(c) ctx.glIndexub(c)
#define dglIndexubv(c) ctx.glIndexubv(c)
#define dglInitNames() ctx.glInitNames()
#define dglInterleavedArrays(format, stride, pointer) ctx.glInterleavedArrays(format, stride, pointer)
#define dglIsEnabled(cap) ctx.glIsEnabled(cap)
#define dglIsList(list) ctx.glIsList(list)
#define dglIsTexture(texture) ctx.glIsTexture(texture)
#define dglLightModelf(pname, param) ctx.glLightModelf(pname, param)
#define dglLightModelfv(pname, params) ctx.glLightModelfv(pname, params)
#define dglLightModeli(pname, param) ctx.glLightModeli(pname, param)
#define dglLightModeliv(pname, params) ctx.glLightModeliv(pname, params)
#define dglLightf(light, pname, param) ctx.glLightf(light, pname, param)
#define dglLightfv(light, pname, params) ctx.glLightfv(light, pname, params)
#define dglLighti(light, pname, param) ctx.glLighti(light, pname, param)
#define dglLightiv(light, pname, params) ctx.glLightiv(light, pname, params)
#define dglLineStipple(factor, pattern) ctx.glLineStipple(factor, pattern)
#define dglLineWidth(width) ctx.glLineWidth(width)
#define dglListBase(base) ctx.glListBase(base)
#define dglLoadIdentity() ctx.glLoadIdentity()
#define dglLoadMatrixd(m) ctx.glLoadMatrixd(m)
#define dglLoadMatrixf(m) ctx.glLoadMatrixf(m)
#define dglLoadName(name) ctx.glLoadName(name)
#define dglLogicOp(opcode) ctx.glLogicOp(opcode)
#define dglMap1d(target, u1, u2, stride, order, points) ctx.glMap1d(target, u1, u2, stride, order, points)
#define dglMap1f(target, u1, u2, stride, order, points) ctx.glMap1f(target, u1, u2, stride, order, points)
#define dglMap2d(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points) ctx.glMap2d(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points)
#define dglMap2f(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points) ctx.glMap2f(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points)
#define dglMapGrid1d(un, u1, u2) ctx.glMapGrid1d(un, u1, u2)
#define dglMapGrid1f(un, u1, u2) ctx.glMapGrid1f(un, u1, u2)
#define dglMapGrid2d(un, u1, u2, vn, v1, v2) ctx.glMapGrid2d(un, u1, u2, vn, v1, v2)
#define dglMapGrid2f(un, u1, u2, vn, v1, v2) ctx.glMapGrid2f(un, u1, u2, vn, v1, v2)
#define dglMaterialf(face, pname, param) ctx.glMaterialf(face, pname, param)
#define dglMaterialfv(face, pname, params) ctx.glMaterialfv(face, pname, params)
#define dglMateriali(face, pname, param) ctx.glMateriali(face, pname, param)
#define dglMaterialiv(face, pname, params) ctx.glMaterialiv(face, pname, params)
#define dglMatrixMode(mode) ctx.glMatrixMode(mode)
#define dglMultMatrixd(m) ctx.glMultMatrixd(m)
#define dglMultMatrixf(m) ctx.glMultMatrixf(m)
#define dglNewList(list, mode) ctx.glNewList(list, mode)
#define dglNormal3b(nx, ny, nz) ctx.glNormal3b(nx, ny, nz)
#define dglNormal3bv(v) ctx.glNormal3bv(v)
#define dglNormal3d(nx, ny, nz) ctx.glNormal3d(nx, ny, nz)
#define dglNormal3dv(v) ctx.glNormal3dv(v)
#define dglNormal3f(nx, ny, nz) ctx.glNormal3f(nx, ny, nz)
#define dglNormal3fv(v) ctx.glNormal3fv(v)
#define dglNormal3i(nx, ny, nz) ctx.glNormal3i(nx, ny, nz)
#define dglNormal3iv(v) ctx.glNormal3iv(v)
#define dglNormal3s(nx, ny, nz) ctx.glNormal3s(nx, ny, nz)
#define dglNormal3sv(v) ctx.glNormal3sv(v)
#define dglNormalPointer(type, stride, pointer) ctx.glNormalPointer(type, stride, pointer)
#define dglOrtho(left, right, bottom, top, zNear, zFar) ctx.glOrtho(left, right, bottom, top, zNear, zFar)
#define dglPassThrough(token) ctx.glPassThrough(token)
#define dglPixelMapfv(map, mapsize, values) ctx.glPixelMapfv(map, mapsize, values)
#define dglPixelMapuiv(map, mapsize, values) ctx.glPixelMapuiv(map, mapsize, values)
#define dglPixelMapusv(map, mapsize, values) ctx.glPixelMapusv(map, mapsize, values)
#define dglPixelStoref(pname, param) ctx.glPixelStoref(pname, param)
#define dglPixelStorei(pname, param) ctx.glPixelStorei(pname, param)
#define dglPixelTransferf(pname, param) ctx.glPixelTransferf(pname, param)
#define dglPixelTransferi(pname, param) ctx.glPixelTransferi(pname, param)
#define dglPixelZoom(xfactor, yfactor) ctx.glPixelZoom(xfactor, yfactor)
#define dglPointSize(size) ctx.glPointSize(size)
#define dglPolygonMode(face, mode) ctx.glPolygonMode(face, mode)
#define dglPolygonOffset(factor, units) ctx.glPolygonOffset(factor, units)
#define dglPolygonStipple(mask) ctx.glPolygonStipple(mask)
#define dglPopAttrib() ctx.glPopAttrib()
#define dglPopClientAttrib() ctx.glPopClientAttrib()
#define dglPopMatrix() ctx.glPopMatrix()
#define dglPopName() ctx.glPopName()
#define dglPrioritizeTextures(n, textures, priorities) ctx.glPrioritizeTextures(n, textures, priorities)
#define dglPushAttrib(mask) ctx.glPushAttrib(mask)
#define dglPushClientAttrib(mask) ctx.glPushClientAttrib(mask)
#define dglPushMatrix() ctx.glPushMatrix()
#define dglPushName(name) ctx.glPushName(name)
#define dglRasterPos2d(x, y) ctx.glRasterPos2d(x, y)
#define dglRasterPos2dv(v) ctx.glRasterPos2dv(v)
#define dglRasterPos2f(x, y) ctx.glRasterPos2f(x, y)
#define dglRasterPos2fv(v) ctx.glRasterPos2fv(v)
#define dglRasterPos2i(x, y) ctx.glRasterPos2i(x, y)
#define dglRasterPos2iv(v) ctx.glRasterPos2iv(v)
#define dglRasterPos2s(x, y) ctx.glRasterPos2s(x, y)
#define dglRasterPos2sv(v) ctx.glRasterPos2sv(v)
#define dglRasterPos3d(x, y, z) ctx.glRasterPos3d(x, y, z)
#define dglRasterPos3dv(v) ctx.glRasterPos3dv(v)
#define dglRasterPos3f(x, y, z) ctx.glRasterPos3f(x, y, z)
#define dglRasterPos3fv(v) ctx.glRasterPos3fv(v)
#define dglRasterPos3i(x, y, z) ctx.glRasterPos3i(x, y, z)
#define dglRasterPos3iv(v) ctx.glRasterPos3iv(v)
#define dglRasterPos3s(x, y, z) ctx.glRasterPos3s(x, y, z)
#define dglRasterPos3sv(v) ctx.glRasterPos3sv(v)
#define dglRasterPos4d(x, y, z, w) ctx.glRasterPos4d(x, y, z, w)
#define dglRasterPos4dv(v) ctx.glRasterPos4dv(v)
#define dglRasterPos4f(x, y, z, w) ctx.glRasterPos4f(x, y, z, w)
#define dglRasterPos4fv(v) ctx.glRasterPos4fv(v)
#define dglRasterPos4i(x, y, z, w) ctx.glRasterPos4i(x, y, z, w)
#define dglRasterPos4iv(v) ctx.glRasterPos4iv(v)
#define dglRasterPos4s(x, y, z, w) ctx.glRasterPos4s(x, y, z, w)
#define dglRasterPos4sv(v) ctx.glRasterPos4sv(v)
#define dglReadBuffer(mode) ctx.glReadBuffer(mode)
#define dglReadPixels(x, y, width, height, format, type, pixels) ctx.glReadPixels(x, y, width, height, format, type, pixels)
#define dglRectd(x1, y1, x2, y2) ctx.glRectd(x1, y1, x2, y2)
#define dglRectdv(v1, v2) ctx.glRectdv(v1, v2)
#define dglRectf(x1, y1, x2, y2) ctx.glRectf(x1, y1, x2, y2)
#define dglRectfv(v1, v2) ctx.glRectfv(v1, v2)
#define dglRecti(x1, y1, x2, y2) ctx.glRecti(x1, y1, x2, y2)
#define dglRectiv(v1, v2) ctx.glRectiv(v1, v2)
#define dglRects(x1, y1, x2, y2) ctx.glRects(x1, y1, x2, y2)
#define dglRectsv(v1, v2) ctx.glRectsv(v1, v2)
#define dglRenderMode(mode) ctx.glRenderMode(mode)
#define dglRotated(angle, x, y, z) ctx.glRotated(angle, x, y, z)
#define dglRotatef(angle, x, y, z) ctx.glRotatef(angle, x, y, z)
#define dglScaled(x, y, z) ctx.glScaled(x, y, z)
#define dglScalef(x, y, z) ctx.glScalef(x, y, z)
#define dglScissor(x, y, width, height) ctx.glScissor(x, y, width, height)
#define dglSelectBuffer(size, buffer) ctx.glSelectBuffer(size, buffer)
#define dglShadeModel(mode) ctx.glShadeModel(mode)
#define dglStencilFunc(func, ref, mask) ctx.glStencilFunc(func, ref, mask)
#define dglStencilMask(mask) ctx.glStencilMask(mask)
#define dglStencilOp(fail, zfail, zpass) ctx.glStencilOp(fail, zfail, zpass)
#define dglTexCoord1d(s) ctx.glTexCoord1d(s)
#define dglTexCoord1dv(v) ctx.glTexCoord1dv(v)
#define dglTexCoord1f(s) ctx.glTexCoord1f(s)
#define dglTexCoord1fv(v) ctx.glTexCoord1fv(v)
#define dglTexCoord1i(s) ctx.glTexCoord1i(s)
#define dglTexCoord1iv(v) ctx.glTexCoord1iv(v)
#define dglTexCoord1s(s) ctx.glTexCoord1s(s)
#define dglTexCoord1sv(v) ctx.glTexCoord1sv(v)
#define dglTexCoord2d(s, t) ctx.glTexCoord2d(s, t)
#define dglTexCoord2dv(v) ctx.glTexCoord2dv(v)
#define dglTexCoord2f(s, t) ctx.glTexCoord2f(s, t)
#define dglTexCoord2fv(v) ctx.glTexCoord2fv(v)
#define dglTexCoord2i(s, t) ctx.glTexCoord2i(s, t)
#define dglTexCoord2iv(v) ctx.glTexCoord2iv(v)
#define dglTexCoord2s(s, t) ctx.glTexCoord2s(s, t)
#define dglTexCoord2sv(v) ctx.glTexCoord2sv(v)
#define dglTexCoord3d(s, t, r) ctx.glTexCoord3d(s, t, r)
#define dglTexCoord3dv(v) ctx.glTexCoord3dv(v)
#define dglTexCoord3f(s, t, r) ctx.glTexCoord3f(s, t, r)
#define dglTexCoord3fv(v) ctx.glTexCoord3fv(v)
#define dglTexCoord3i(s, t, r) ctx.glTexCoord3i(s, t, r)
#define dglTexCoord3iv(v) ctx.glTexCoord3iv(v)
#define dglTexCoord3s(s, t, r) ctx.glTexCoord3s(s, t, r)
#define dglTexCoord3sv(v) ctx.glTexCoord3sv(v)
#define dglTexCoord4d(s, t, r, q) ctx.glTexCoord4d(s, t, r, q)
#define dglTexCoord4dv(v) ctx.glTexCoord4dv(v)
#define dglTexCoord4f(s, t, r, q) ctx.glTexCoord4f(s, t, r, q)
#define dglTexCoord4fv(v) ctx.glTexCoord4fv(v)
#define dglTexCoord4i(s, t, r, q) ctx.glTexCoord4i(s, t, r, q)
#define dglTexCoord4iv(v) ctx.glTexCoord4iv(v)
#define dglTexCoord4s(s, t, r, q) ctx.glTexCoord4s(s, t, r, q)
#define dglTexCoord4sv(v) ctx.glTexCoord4sv(v)
#define dglTexCoordPointer(size, type, stride, pointer) ctx.glTexCoordPointer(size, type, stride, pointer)
#define dglTexEnvf(target, pname, param) ctx.glTexEnvf(target, pname, param)
#define dglTexEnvfv(target, pname, params) ctx.glTexEnvfv(target, pname, params)
#define dglTexEnvi(target, pname, param) ctx.glTexEnvi(target, pname, param)
#define dglTexEnviv(target, pname, params) ctx.glTexEnviv(target, pname, params)
#define dglTexGend(coord, pname, param) ctx.glTexGend(coord, pname, param)
#define dglTexGendv(coord, pname, params) ctx.glTexGendv(coord, pname, params)
#define dglTexGenf(coord, pname, param) ctx.glTexGenf(coord, pname, param)
#define dglTexGenfv(coord, pname, params) ctx.glTexGenfv(coord, pname, params)
#define dglTexGeni(coord, pname, param) ctx.glTexGeni(coord, pname, param)
#define dglTexGeniv(coord, pname, params) ctx.glTexGeniv(coord, pname, params)
#define dglTexImage1D(target, level, internalformat, width, border, format, type, pixels) ctx.glTexImage1D(target, level, internalformat, width, border, format, type, pixels)
#define dglTexImage2D(target, level, internalformat, width, height, border, format, type, pixels) ctx.glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels)
#define dglTexParameterf(target, pname, param) ctx.glTexParameterf(target, pname, param)
#define dglTexParameterfv(target, pname, params) ctx.glTexParameterfv(target, pname, params)
#define dglTexParameteri(target, pname, param) ctx.glTexParameteri(target, pname, param)
#define dglTexParameteriv(target, pname, params) ctx.glTexParameteriv(target, pname, params)
#define dglTexSubImage1D(target, level, xoffset, width, format, type, pixels) ctx.glTexSubImage1D(target, level, xoffset, width, format, type, pixels)
#define dglTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels) ctx.glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels)
#define dglTranslated(x, y, z) ctx.glTranslated(x, y, z)
#define dglTranslatef(x, y, z) ctx.glTranslatef(x, y, z)
#define dglVertex2d(x, y) ctx.glVertex2d(x, y)
#define dglVertex2dv(v) ctx.glVertex2dv(v)
#define dglVertex2f(x, y) ctx.glVertex2f(x, y)
#define dglVertex2fv(v) ctx.glVertex2fv(v)
#define dglVertex2i(x, y) ctx.glVertex2i(x, y)
#define dglVertex2iv(v) ctx.glVertex2iv(v)
#define dglVertex2s(x, y) ctx.glVertex2s(x, y)
#define dglVertex2sv(v) ctx.glVertex2sv(v)
#define dglVertex3d(x, y, z) ctx.glVertex3d(x, y, z)
#define dglVertex3dv(v) ctx.glVertex3dv(v)
#define dglVertex3f(x, y, z) ctx.glVertex3f(x, y, z)
#define dglVertex3fv(v) ctx.glVertex3fv(v)
#define dglVertex3i(x, y, z) ctx.glVertex3i(x, y, z)
#define dglVertex3iv(v) ctx.glVertex3iv(v)
#define dglVertex3s(x, y, z) ctx.glVertex3s(x, y, z)
#define dglVertex3sv(v) ctx.glVertex3sv(v)
#define dglVertex4d(x, y, z, w) ctx.glVertex4d(x, y, z, w)
#define dglVertex4dv(v) ctx.glVertex4dv(v)
#define dglVertex4f(x, y, z, w) ctx.glVertex4f(x, y, z, w)
#define dglVertex4fv(v) ctx.glVertex4fv(v)
#define dglVertex4i(x, y, z, w) ctx.glVertex4i(x, y, z, w)
#define dglVertex4iv(v) ctx.glVertex4iv(v)
#define dglVertex4s(x, y, z, w) ctx.glVertex4s(x, y, z, w)
#define dglVertex4sv(v) ctx.glVertex4sv(v)
#define dglVertexPointer(size, type, stride, pointer) ctx.glVertexPointer(size, type, stride, pointer)
#define dglViewport(x, y, width, height) ctx.glViewport(x, y, width, height)
#else
...
// [AM] Now available in SDL2.
// #if !defined(__IPHONEOS__) && !defined(SVE_PLAT_SWITCH)
...
#define dglCreateShaderObjectARB(shaderType) _glCreateShader(shaderType)
#define dglShaderSourceARB(shaderObj, count, string, length) _glShaderSource(shaderObj, count, string, length)
#define dglCompileShaderARB(shaderObj) _glCompileShader(shaderObj)
#define dglCreateProgramObjectARB() _glCreateProgram()
#define dglAttachObjectARB(containerObj, obj) _glAttachShader(containerObj, obj)
#define dglLinkProgramARB(programObj) _glLinkProgram(programObj)
#define dglUseProgramObjectARB(programObj) _glUseProgram(programObj)
#define dglValidateProgramARB(programObj) _glValidateProgramARB(programObj)
#define dglUniform1fARB(location, v0) _glUniform1f(location, v0)
#define dglUniform2fARB(location, v0, v1) _glUniform2f(location, v0, v1)
#define dglUniform3fARB(location, v0, v1, v2) _glUniform3f(location, v0, v1, v2)
#define dglUniform4fARB(location, v0, v1, v2, v3) _glUniform4f(location, v0, v1, v2, v3)
#define dglUniform1iARB(location, v0) _glUniform1i(location, v0)
#define dglUniform2iARB(location, v0, v1) _glUniform2i(location, v0, v1)
#define dglUniform3iARB(location, v0, v1, v2) _glUniform3i(location, v0, v1, v2)
#define dglUniform4iARB(location, v0, v1, v2, v3) _glUniform4i(location, v0, v1, v2, v3)
#define dglUniform1fvARB(location, count, value) _glUniform1fv(location, count, value)
#define dglUniform2fvARB(location, count, value) _glUniform2fv(location, count, value)
#define dglUniform3fvARB(location, count, value) _glUniform3fv(location, count, value)
#define dglUniform4fvARB(location, count, value) _glUniform4fv(location, count, value)
#define dglUniform1ivARB(location, count, value) _glUniform1iv(location, count, value)
#define dglUniform2ivARB(location, count, value) _glUniform2iv(location, count, value)
#define dglUniform3ivARB(location, count, value) _glUniform3iv(location, count, value)
#define dglUniform4ivARB(location, count, value) _glUniform4iv(location, count, value)
#define dglUniformMatrix2fvARB(location, count, transpose, value) _glUniformMatrix2fv(location, count, transpose, value)
#define dglUniformMatrix3fvARB(location, count, transpose, value) _glUniformMatrix3fv(location, count, transpose, value)
#define dglUniformMatrix4fvARB(location, count, transpose, value) _glUniformMatrix4fv(location, count, transpose, value)
#define dglGetObjectParameterfvARB(obj, pname, params) _glGetObjectParameterfv(obj, pname, params)
#define dglGetObjectParameterivARB(obj, pname, params) _glGetProgramiv(obj, pname, params)
...
#define dglGetUniformLocationARB(programObj, name) _glGetUniformLocation(programObj, name)
...
#ifdef SVE_PLAT_SWITCH
#define dglIsRenderbuffer(renderbuffer) _glIsRenderbufferEXT(renderbuffer)
#define dglBindRenderbuffer(target, renderbuffer) _glBindRenderbufferEXT(target, renderbuffer)
#define dglDeleteRenderbuffers(n, renderbuffers) _glDeleteRenderbuffersEXT(n, renderbuffers)
#define dglGenRenderbuffers(n, renderbuffers) _glGenRenderbuffersEXT(n, renderbuffers)
#define dglRenderbufferStorage(target, internalformat, width, height) _glRenderbufferStorageEXT(target, internalformat, width, height)
#define dglGetRenderbufferParameteriv(target, pname, params) _glGetRenderbufferParameterivEXT(target, pname, params)
#define dglIsFramebuffer(framebuffer) _glIsFramebufferEXT(framebuffer)
#define dglBindFramebuffer(target, framebuffer) _glBindFramebufferEXT(target, framebuffer)
#define dglDeleteFramebuffers(n, framebuffers) _glDeleteFramebuffersEXT(n, framebuffers)
#define dglGenFramebuffers(n, framebuffers) _glGenFramebuffersEXT(n, framebuffers)
#define dglCheckFramebufferStatus(target) _glCheckFramebufferStatusEXT(target)
#define dglFramebufferTexture1D(target, attachment, textarget, texture, level) _glFramebufferTexture1DEXT(target, attachment, textarget, texture, level)
#define dglFramebufferTexture2D(target, attachment, textarget, texture, level) _glFramebufferTexture2DEXT(target, attachment, textarget, texture, level)
#define dglFramebufferTexture3D(target, attachment, textarget, texture, level, zoffset) _glFramebufferTexture3DEXT(target, attachment, textarget, texture, level, zoffset)
#define dglFramebufferRenderbuffer(target, attachment, renderbuffertarget, renderbuffer) _glFramebufferRenderbufferEXT(target, attachment, renderbuffertarget, renderbuffer)
#define dglGetFramebufferAttachmentParameteriv(target, attachment, pname, params) _glGetFramebufferAttachmentParameterivEXT(target, attachment, pname, params)
#define dglGenerateMipmap(target) _glGenerateMipmapEXT(target)
#define dglBlitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter) _glBlitFramebufferEXT(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter)
#define dglRenderbufferStorageMultisample(target, samples, internalformat, width, height) _glRenderbufferStorageMultisampleEXT(target, samples, internalformat, width, height)
#define dglFramebufferTextureLayer(target, attachment, texture, level, layer) _glFramebufferTextureLayerEXT(target, attachment, texture, level, layer)
#else
