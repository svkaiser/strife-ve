...
//
// DESCRIPTION:
//    Main entry point for Strife-VE Cocoa application
//
// AUTHORS:
//    Samuel Villarreal
//    Darrell Walisser <dwaliss1@purdue.edu> (Initial version)
//
...
static void setApplicationMenu(void)
{
    ...
    [appleMenu addItemWithTitle: @"Take Screenshot"
                               ...
                               with: (NSString*)aString
{
    ...
    [aString getCharacters: (buffer+aRange.location)
                     range: localRange];
    ...
    /* Build output string */
    result = [NSString stringWithCharacters: buffer
                                     length: bufferSize];
